        ...
        <div className="relative h-full w-full bg-[url('/images/hero.jpg')] bg-no-repeat bg-center bg-fixed bg-cover">
            <div className="bg-black w-full h-full lg:bg-opacity-50">
                ...
                <div className="flex justify-center">
                    <div className="bg-black self-center bg-opacity-70 px-16 py-16  mt-2 lg:w-2/5 lg:max-w-md rounded-md w-full">
                        ...
                        <button onClick={variant === "login" ? login : register} className="bg-red-600 py-3 text-white rounded-md w-full mt-10 hover:bg-red-700 transition">{variant === 'login' ? "login" : 'register'}</button>
                        ...
                        <p className="text-neutral-500 mt-12">{variant === 'login' ? "First time using Netflix?" : 'Already have an account?'} <span onClick={toggleVariant} className="text-white ml-1 cursor-pointer hover:underline">{variant === 'login' ? "Create an Account" : 'Login'}</span></p>
                    </div>
                </div>
            </div>
        </div>
