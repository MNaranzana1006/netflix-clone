...
const Input: React.FC<inputProps> = ({
  ...
  return (
    <div className='relative'>
        <input id={id} onChange={onChange} type={type} value={value} className='block rounded-md px-6 pt-6 pb-1 w-full text-md text-white bg-neutral-700 appearance-none focus:outline-none focus:ring-0 peer' placeholder=' '/>
